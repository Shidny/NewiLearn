...
You have Reset your password in RFC's iLearn Portal. This system houses the online version of the Company's policies and practices.<br/><br/>

To view, click this link https://policy.rfc.com.ph, and enter your default credentials as follows:<br/><br/>


<h5> here is your credential </h5>

Username: {{ $data['username'] }}<br/>
Password: {{ $data['username'] }}<br/><br/>
